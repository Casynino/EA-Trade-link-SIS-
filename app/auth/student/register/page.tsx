...
function Form() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    fd.set("userTypes", JSON.stringify(["STUDENT"]))
    setLoading(true)
    try {
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.45)" }}>
            Free to sign up. Start your application right after.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              <label className="block text-xs font-semibold mb-1.5" style={{ color: "rgba(255,255,255,0.7)" }}>Phone (optional)</label>
        ...
        <p className="mt-5 text-center text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
          ...
          <Link href={`/auth/student/login?redirect=${encodeURIComponent(redirect)}`}
