...
import { Briefcase, Globe2, Eye, EyeOff, Loader2, ArrowRight, AlertCircle } from "lucide-react"
...
function Form() {
  ...
  const [roleError, setRoleError] = useState<"STUDENT" | "ADMIN" | null>(null)
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.45)" }}>
            Continue your business service request.
          </p>
        </div>
        ...
        {roleError === "STUDENT" && (
          <div className="rounded-xl p-4 mb-5 flex gap-3"
            ...
            <div>
              <p className="text-sm font-semibold text-red-300 mb-1">This is a Student account</p>
              <p className="text-xs text-red-300/70">
                This email is registered as a Student account. To apply for studies,{" "}
                <Link href={`/auth/student/login?redirect=/apply-to-china`} className="underline font-semibold">
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
          ...
          <Link href={`/auth/business/register?redirect=${encodeURIComponent(redirect)}`}
